...
//        FileUtils.copyFile(newHTML, globalIndex);
    ...
    // Look into removing all the Jekyll stuff from gh-pages branch
    // Markdown instead of HTML for maintainability purposes
    // Move user-generated Main.java to main branch, and automatically copy it to gh-pages branch
